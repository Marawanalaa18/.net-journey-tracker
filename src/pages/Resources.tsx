...
const typeColors: Record<string, string> = {
  ...
  repo: "bg-foreground/10 text-foreground",
        ...
        {filtered.map((resource, i) => {
          ...
          return (
            <a
              ...
              className="glass-card group animate-fade-in p-5 transition-all hover:scale-[1.02] hover:border-primary/30"
              style={{ animationDelay: `${i * 40}ms`, opacity: 0 }}
            >
              <div className="mb-3 flex items-center justify-between">
                <span className={`inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-xs font-medium ${typeColors[resource.type]}`}>
